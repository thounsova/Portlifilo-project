    ...
    <div className="min-h-screen bg-gray-900 text-white overflow-x-hidden">
      ...
      >
        ...
        <div className="lg:hidden w-full">
          <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-20 border-t border-gray-700/50 mt-16">
            <div className="px-6">
              <motion.div
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xl text-gray-300 font-light mb-4">Full-Stack Developer</p>
                </div>
              </motion.div>
            </div>
          </div>
